...
headerfile,imageData = getTextFromPPMFile(sys.argv[1])

# save the image data in a temp file
with open("tempImageData.txt", "wb") as file:
...
bv  =  BitVector(filename = 'tempImageData.txt')

   
# open output file
FILEOUT = open(sys.argv[3], 'ab')
